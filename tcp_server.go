...
func handleConnection(conn net.Conn, clientId int, clientList* ConnectionList) {
    ...
    Loop:
        for {
            ...
            case Goodbye:
                ...
                // quit loop (conn should close since we deferred above)
                break Loop
    ...
    // TODO: have some way of checking for broken connections (e.g. send a small keep-alive msg to each client? or vice versa)
